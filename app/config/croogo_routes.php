<?php
    ...
    // Users
    //CroogoRouter::connect('/register', array('controller' => 'users', 'action' => 'add'));// nao sei porque nao estava funcionando
    CroogoRouter::connect('/user/:username', array('controller' => 'users', 'action' => 'view'), array('pass' => array('username')));

    // Contact
    //CroogoRouter::connect('/contact', array('controller' => 'contacts', 'action' => 'view', 'contact'));// nao sei porque nao estava funcionando
    //CroogoRouter::connect('/atendimento', array('controller' => 'contacts', 'action' => 'view', 'contact'));// nao sei porque nao estava funcionando
