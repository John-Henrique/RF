...
<div id="nav">
    <ul class="sf-menu">
        ...
        <li>
            <a href="#"><span class="ui-icon ui-icon-link"></span><?php __('Produtos'); ?></a>
            <ul>
                <li><?php echo $html->link('<span class="ui-icon ui-icon-link"></span>' . __('Listar produtos', true), array('plugin' => null, 'controller' => 'produtos', 'action' => 'index'), array('escape' => false)); ?></li>
                <li><?php echo $html->link('<span class="ui-icon ui-icon-plus"></span>' . __('Novo produto', true), array('plugin' => null, 'controller' => 'produtos', 'action' => 'add'), array('class' => 'separator', 'escape' => false)); ?></li>
            </ul>
        </li>

        <li>
            <a href="#"><span class="ui-icon ui-icon-link"></span><?php __('Rastrear'); ?></a>
            <ul>
                <li><?php echo $html->link('<span class="ui-icon ui-icon-link"></span>' . __('Listar códigos', true), array('plugin' => null, 'controller' => 'codigos', 'action' => 'index'), array('escape' => false)); ?></li>
                <li><?php echo $html->link('<span class="ui-icon ui-icon-plus"></span>' . __('Novo código', true), array('plugin' => null, 'controller' => 'codigos', 'action' => 'add'), array('class' => 'separator', 'escape' => false)); ?></li>
            </ul>
        </li>

<?php
/**
 * Se possui permissão comum não poderá ver todos os itens
 */
if( $userData['role_id'] == 1 ){
?>
   
        <li>
            <a href="#"><span class="ui-icon ui-icon-link"></span><?php __('Avisos'); ?></a>
            <ul>
                <li><?php echo $html->link('<span class="ui-icon ui-icon-link"></span>' . __('Listar avisos', true), array('plugin' => null, 'controller' => 'avisos', 'action' => 'index'), array('escape' => false)); ?></li>
                <li><?php echo $html->link('<span class="ui-icon ui-icon-plus"></span>' . __('Novo aviso', true), array('plugin' => null, 'controller' => 'avisos', 'action' => 'add'), array('class' => 'separator', 'escape' => false)); ?></li>
            </ul>
        </li>
...
?>
        ...
        <li>
            <a href="#"><span class="ui-icon ui-icon-person"></span><?php __('Users'); ?></a>
            <ul>
                <li><?php echo $html->link('<span class="ui-icon ui-icon-person"></span>' . __('Mudar senha', true), array('plugin' => null, 'controller' => 'users', 'action' => 'reset_password', $userData['id'] ), array('escape' => false)); ?></li>
            </ul>
        </li>
<?php } ?>
